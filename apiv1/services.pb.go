...
type PublishDocumentRequest struct {
	...
	Administrator  *Identifier          `protobuf:"bytes,5,opt,name=administrator,proto3" json:"administrator,omitempty"`                            // administrator/typed/prepared by  (may be same as author)
	...
	Recipients     []*Identifier        `protobuf:"bytes,7,rep,name=recipients,proto3" json:"recipients,omitempty"`                                  // recipients - e.g. the patient, other practitioners, other teams. Resolution of these is transport specific.
	Title          string               `protobuf:"bytes,8,opt,name=title,proto3" json:"title,omitempty"`                                            // title (description) of this document
	DateTime       *timestamp.Timestamp `protobuf:"bytes,9,opt,name=date_time,json=dateTime,proto3" json:"date_time,omitempty"`                      // logical date/time of the document - may be the "event" date time
	TypedDateTime  *timestamp.Timestamp `protobuf:"bytes,10,opt,name=typed_date_time,json=typedDateTime,proto3" json:"typed_date_time,omitempty"`    // when document typed
	SignedDateTime *timestamp.Timestamp `protobuf:"bytes,11,opt,name=signed_date_time,json=signedDateTime,proto3" json:"signed_date_time,omitempty"` // when document signed off
	Data           *Attachment          `protobuf:"bytes,12,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (x *PublishDocumentRequest) GetAdministrator() *Identifier {
	if x != nil {
...
func (x *PublishDocumentRequest) GetRecipients() []*Identifier {
	if x != nil {
		return x.Recipients
	}
	return nil
...
func (x *PublishDocumentRequest) GetData() *Attachment {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_services_proto_rawDesc = []byte{
	...
	0x0a, 0x14, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x4d, 0x61, 0x70, 0x52,
	...
	0x61, 0x6c, 0x75, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x75,
	0x72, 0x69, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74,
	0x55, 0x72, 0x69, 0x22, 0xe4, 0x04, 0x0a, 0x16, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x44,
	...
	0x6e, 0x74, 0x52, 0x07, 0x70, 0x61, 0x74, 0x69, 0x65, 0x6e, 0x74, 0x12, 0x2b, 0x0a, 0x07, 0x61,
	0x75, 0x74, 0x68, 0x6f, 0x72, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x61,
	0x70, 0x69, 0x76, 0x31, 0x2e, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x52,
	0x07, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x73, 0x12, 0x33, 0x0a, 0x0b, 0x72, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x69, 0x62, 0x6c, 0x65, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e,
	...
	0x74, 0x65, 0x72, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x61, 0x70, 0x69, 0x76,
	...
	0x69, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x61, 0x70,
	...
	0x12, 0x37, 0x0a, 0x09, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x09, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52,
	0x08, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x42, 0x0a, 0x0f, 0x74, 0x79, 0x70,
	0x65, 0x64, 0x5f, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x0a, 0x20, 0x01,
	...
	0x69, 0x6d, 0x65, 0x12, 0x25, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x0c, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x11, 0x2e, 0x61, 0x70, 0x69, 0x76, 0x31, 0x2e, 0x41, 0x74, 0x74, 0x61, 0x63, 0x68,
	0x6d, 0x65, 0x6e, 0x74, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x3c, 0x0a, 0x17, 0x50, 0x75,
	...
	0x66, 0x69, 0x65, 0x72, 0x52, 0x02, 0x69, 0x64, 0x22, 0x8b, 0x01, 0x0a, 0x19, 0x50, 0x72, 0x61,
	0x63, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x12, 0x1a,
	...
	0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0xab, 0x01, 0x0a, 0x0d, 0x41, 0x75, 0x74, 0x68, 0x65,
	0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x48, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69,
	0x6e, 0x12, 0x13, 0x2e, 0x61, 0x70, 0x69, 0x76, 0x31, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x61, 0x70, 0x69, 0x76, 0x31, 0x2e, 0x4c,
	...
	,
...
var file_services_proto_goTypes = []interface{}{
	...
	(*PractitionerSearchRequest)(nil), // 3: apiv1.PractitionerSearchRequest
	(*Identifier)(nil),                // 4: apiv1.Identifier
	(*Patient)(nil),                   // 5: apiv1.Patient
	(*timestamp.Timestamp)(nil),       // 6: google.protobuf.Timestamp
	(*Attachment)(nil),                // 7: apiv1.Attachment
	(*LoginRequest)(nil),              // 8: apiv1.LoginRequest
	(*TokenRefreshRequest)(nil),       // 9: apiv1.TokenRefreshRequest
	(*LoginResponse)(nil),             // 10: apiv1.LoginResponse
	(*any.Any)(nil),                   // 11: google.protobuf.Any
	(*Practitioner)(nil),              // 12: apiv1.Practitioner
}
var file_services_proto_depIdxs = []int32{
	4,  // 0: apiv1.PublishDocumentRequest.id:type_name -> apiv1.Identifier
	5,  // 1: apiv1.PublishDocumentRequest.patient:type_name -> apiv1.Patient
	4,  // 2: apiv1.PublishDocumentRequest.authors:type_name -> apiv1.Identifier
	4,  // 3: apiv1.PublishDocumentRequest.responsible:type_name -> apiv1.Identifier
	4,  // 4: apiv1.PublishDocumentRequest.administrator:type_name -> apiv1.Identifier
	4,  // 5: apiv1.PublishDocumentRequest.encounter:type_name -> apiv1.Identifier
	4,  // 6: apiv1.PublishDocumentRequest.recipients:type_name -> apiv1.Identifier
	6,  // 7: apiv1.PublishDocumentRequest.date_time:type_name -> google.protobuf.Timestamp
	6,  // 8: apiv1.PublishDocumentRequest.typed_date_time:type_name -> google.protobuf.Timestamp
	6,  // 9: apiv1.PublishDocumentRequest.signed_date_time:type_name -> google.protobuf.Timestamp
	7,  // 10: apiv1.PublishDocumentRequest.data:type_name -> apiv1.Attachment
	4,  // 11: apiv1.PublishDocumentResponse.id:type_name -> apiv1.Identifier
	8,  // 12: apiv1.Authenticator.Login:input_type -> apiv1.LoginRequest
	9,  // 13: apiv1.Authenticator.Refresh:input_type -> apiv1.TokenRefreshRequest
	4,  // 14: apiv1.Identifiers.GetIdentifier:input_type -> apiv1.Identifier
	0,  // 15: apiv1.Identifiers.MapIdentifier:input_type -> apiv1.IdentifierMapRequest
	1,  // 16: apiv1.DocumentService.PublishDocument:input_type -> apiv1.PublishDocumentRequest
	3,  // 17: apiv1.PractitionerDirectory.SearchPractitioner:input_type -> apiv1.PractitionerSearchRequest
	10, // 18: apiv1.Authenticator.Login:output_type -> apiv1.LoginResponse
	10, // 19: apiv1.Authenticator.Refresh:output_type -> apiv1.LoginResponse
	11, // 20: apiv1.Identifiers.GetIdentifier:output_type -> google.protobuf.Any
	4,  // 21: apiv1.Identifiers.MapIdentifier:output_type -> apiv1.Identifier
	2,  // 22: apiv1.DocumentService.PublishDocument:output_type -> apiv1.PublishDocumentResponse
	12, // 23: apiv1.PractitionerDirectory.SearchPractitioner:output_type -> apiv1.Practitioner
